...
public class FMUtils {
    ...
    public void ouputFile(String ftlName, String fileName,
        ...
        // 设置模板的包路径
        config.setClassForTemplateLoading(this.getClass(), "/com/bac/ftl");
        // 获得包的模板
        Template template = config.getTemplate(ftlName);
        // 指定文件输出的路径
        String path = "D:\\Freemaker\\out";
	...
	/*	//同时把生成html页面上传到静态页面服务器
		//连接linux服务
		ChannelSftp channelSftp = SftpUtil.connect("192.168.66.66", 22, "root", "root");
		//上传
